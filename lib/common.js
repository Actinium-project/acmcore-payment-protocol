...
PaymentProtocol.LEGACY_PAYMENT.ACM.REQUEST_CONTENT_TYPE = 'application/actinium-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.ACM.CONTENT_TYPE = 'application/actinium-payment';
PaymentProtocol.LEGACY_PAYMENT.ACM.ACK_CONTENT_TYPE = 'application/actinium-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'ACM';
  this.setObj(obj);
  return this;
};
...
function magicHash(str) {
  var magicBytes = new Buffer('Actinium Signed Message:\n');
